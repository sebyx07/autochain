...
#                                           admin_users GET    /admin/administrate/users(.:format)                                                                   admin/users#index
#                                                       POST   /admin/administrate/users(.:format)                                                                   admin/users#create
#                                        new_admin_user GET    /admin/administrate/users/new(.:format)                                                               admin/users#new
#                                       edit_admin_user GET    /admin/administrate/users/:id/edit(.:format)                                                          admin/users#edit
#                                            admin_user GET    /admin/administrate/users/:id(.:format)                                                               admin/users#show
#                                                       PATCH  /admin/administrate/users/:id(.:format)                                                               admin/users#update
#                                                       PUT    /admin/administrate/users/:id(.:format)                                                               admin/users#update
#                                                       DELETE /admin/administrate/users/:id(.:format)                                                               admin/users#destroy
#                                            admin_root GET    /admin/administrate(.:format)                                                                         admin/users#index
...
#                                     letter_opener_web        /dev/emails                                                                                           LetterOpenerWeb::Engine
...
#                               authentication_activate GET    /authentication/activate/:code(.:format)                                                              authentication#activate
#                         authentication_reset_password GET    /authentication/reset_password/:code(.:format)                                                        authentication#reset_password
#                                                       POST   /authentication/reset_password/:code(.:format)                                                        authentication#reset_password_post
...
#                                      upload_image_car POST   /cars/:id/upload_image(.:format)                                                                      cars#upload_image
#                                      delete_image_car DELETE /cars/:id/delete_image/:image_id(.:format)                                                            cars#delete_image
...
#                                  upload_image_api_car POST   /api/cars/:id/upload_image(.:format)                                                                  api/cars#upload_image
#                                  remove_image_api_car POST   /api/cars/:id/remove_image/:attachment_id(.:format)                                                   api/cars#remove_image
#                                              api_cars GET    /api/cars(.:format)                                                                                   api/cars#index
#                                                       POST   /api/cars(.:format)                                                                                   api/cars#create
#                                               api_car GET    /api/cars/:id(.:format)                                                                               api/cars#show
#                                                       PATCH  /api/cars/:id(.:format)                                                                               api/cars#update
#                                                       PUT    /api/cars/:id(.:format)                                                                               api/cars#update
#                                                       DELETE /api/cars/:id(.:format)                                                                               api/cars#destroy
#
...
Rails.application.routes.draw do
  ...
  namespace :authentication do
    get "current_user", action: :get_current_user
    get "", action: :login
  ...
  namespace :api do
    ...
    jsonapi_resources :cars do
      get :brands_models, on: :collection
      post :upload_image, on: :member
      post :remove_image, path: "/remove_image/:attachment_id", on: :member
    end
  end
