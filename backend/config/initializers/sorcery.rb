...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.key = "1587393188038412"
  config.facebook.secret = "de05297bda24b4f762926c207cccde56"
  config.facebook.callback_url = "#{Rails.application.routes.default_url_options[:host]}/oauth/callback?provider=facebook"
